...
<div
  class={{
    "bg-window rounded-box @container fixed box-content overflow-hidden shadow-2xl shadow-black/20 transition-opacity [[data-window-active]]:shadow-black/40": true,
